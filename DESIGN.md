...
- **Three voices in type, no more.** Inter for clarity, Playfair Display italic for one editorial moment per surface, JetBrains Mono for micro-type. Resist the urge to add a fourth.
